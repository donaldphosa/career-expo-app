...
const ForgotPassword = ({navigation}) => {
  ...
  return (
    ...
    <View style={{height:height*0.965}}>
         ...
         <Text style={{color:'#c7c7c0',fontSize:14,marginVertical:20}}>An Email will be sent with a reset password link</Text>
          <View style={{alignItems:'center',flexDirection:'row',marginBottom:30}}>
            <Text style={{color:'#c7c7c0',fontSize:14,marginRight:5}}>Bact to</Text>
